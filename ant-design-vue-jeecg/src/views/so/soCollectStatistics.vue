    ...
    <div class="table-page-search-wrapper">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="24">
            <a-form-item label="未收款" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
              <j-dict-select-tag type="list" v-model="queryParam.noPayReq" dictCode="is_open"
                                 placeholder="是否未收款"/>
            </a-form-item>
          </a-col>
...
import JSelectCustomer from "@comp/jeecgbiz/JSelectCustomer";
import {getAction} from '@/api/manage'
import {FormTypes} from "@/utils/JEditableTableUtil";

export default {
  name: 'PoPayStatistics',
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          title: '累计收款金额',
          width: 100,
          dataIndex: 'sumReqAmount',
        },
        {
          title: '未收款金额',
          width: 100,
          dataIndex: 'sumNoAmount',
          customRender(text, row, index) {
            return row.payAmount - row.sumReqAmount;
          }
        },
        {
          title: '备注',
