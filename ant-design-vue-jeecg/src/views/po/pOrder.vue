...
<!--                     @handleSuperQuery="handleSuperQuery"></j-super-query>-->
      ...
      >
        <template slot="expandedRowRender" slot-scope="record">
          <a-tabs tabPosition="top">
            ...
            <a-tab-pane tab="付款计划" key="collectPayPlan" forceRender>
        ...
        <template slot="customRenderStatus" slot-scope="status">
          ...
          <a-tag v-if="status === '3'" color="blue">完成入库</a-tag>
        </template>
    ...
    <p-order-modal ref="modalForm" @ok="modalFormOk"/>
...
import pOrderModal from './modules/pOrderModal'
...
export default {
  ...
  data() {
    return {
      ...
      expandedRowKeys: [],
      url: {
        list: '/bill/bill/list/po',
        delete: '/bill/bill/delete',
        deleteBatch: '/bill/bill/deleteBatch',
        exportXlsUrl: '/bill/bill/exportXls/po',
  ...
  methods: {
    ...
    getSuperFieldList() {
      ...
      fieldList.push({
        ...
        value: 'clientName',
        text: '客商名称',
        popup: {code: 'byx_merchant', field: 'name', orgFields: 'name', destFields: 'client_name'}
      })
