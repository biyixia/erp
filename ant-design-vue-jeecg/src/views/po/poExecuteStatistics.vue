    ...
    <div class="table-page-search-wrapper">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="24">
            <a-form-item label="预警天数" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
              <a-input placeholder="请输入预警天数查询" v-model="queryParam.noticeDays"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          title: '未入库数量', dataIndex: 'noInBound', width: 100,
          customRender(text, row, index) {
  ...
  methods: {
    async loadData(arg) {
      ...
      this.loading = true
      params.total = true;
      getAction('/bill/bill/referPoList/po', params).then(res => {
        if (res.success) {
