<template>
  <a-spin :spinning="confirmLoading">
    ...
    <j-select-pro-craft-modal consign="0" @ok="selectOK" ref="selectPro"/>
  </a-spin>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        add: "/bill/bill/add/protr",
        edit: "/bill/bill/edit",
        craftDetail: {
          list: '/bill/bill/queryCraftDetailByMainId'
        },
        rule: {
          orderNum: '/sys/fillRule/executeRuleByCode/ptrl_num'
        },
      }
    }
  },
