        ...
        <a-row>
          ...
          <a-col :xs="24" :sm="12">
            <a-form-model-item label="客户名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="clientName">
              <j-select-merchant v-model="model.clientId"/>
            </a-form-model-item>
          </a-col>
          <a-col :xs="24" :sm="12">
            <a-form-model-item label="调入仓库" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="inWarehouseId">
              <j-select-warehouse ownership="customer" v-model="model.inWarehouseId"/>
            </a-form-model-item>
          </a-col>
          <a-col :xs="24" :sm="12">
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        add: "/bill/bill/add/iia",
        edit: "/bill/bill/edit",
        billingDetail: {
          list: '/bill/bill/queryBillingDetailByMainId'
        },
        rule: {
          orderNum: '/sys/fillRule/executeRuleByCode/inventory_in_by_A_num'
        },
      }
    }
  },
