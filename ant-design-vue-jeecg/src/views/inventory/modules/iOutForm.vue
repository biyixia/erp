<template>
  <a-spin :spinning="confirmLoading">
    ...
    <j-select-i-t-modal :out-warehouse-id="model.outWarehouseId" @ok="selectOK" ref="selectIT"/>
  </a-spin>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        add: "/bill/bill/add/io",
        edit: "/bill/bill/edit",
        billingDetail: {
          list: '/bill/bill/queryBillingDetailByMainId'
        },
        rule: {
          orderNum: '/sys/fillRule/executeRuleByCode/inventory_out_num'
        },
      }
    }
  },
  ...
  methods: {
    ...
    getReferITData(){
      if (this.model.outWarehouseId === undefined) {
