<template>
  <a-card class="j-inner-table-wrapper" title="ROP查询" :bordered="false">
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          title: '需求日期',
          key: 'bill.demandedDate',
          dataIndex: ['bill', 'demandedDate'],
  ...
  methods: {
    async loadData(arg) {
      ...
      this.loading = true
      getAction('/bill/bill/searchRop', params).then(res => {
        if (res.success) {
