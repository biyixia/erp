  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/initial/materialType/rootList",
          childList: "/initial/materialType/childList",
          getChildListBatch: "/initial/materialType/getChildListBatch",
          delete: "/initial/materialType/delete",
          deleteBatch: "/initial/materialType/deleteBatch",
          exportXlsUrl: "/initial/materialType/exportXls",
          importExcelUrl: "initial/materialType/importExcel",
        },
        expandedRowKeys:[],
    ...
    methods: {
      ...
      getQueryParams(arg) {
        ...
        this.isorter.column = 'pid,sorter'
        if(arg){
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'code',text:'分类编码',dictCode:''})
        fieldList.push({type:'string',value:'name',text:'分类名称',dictCode:''})
        fieldList.push({type:'string',value:'pid',text:'上级分类',dictCode:''})
        fieldList.push({type:'string',value:'sorter',text:'显示顺序',dictCode:''})
