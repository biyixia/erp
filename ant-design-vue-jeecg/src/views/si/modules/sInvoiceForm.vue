<template>
  <a-spin :spinning="confirmLoading">
      ...
      <a-tab-pane tab="发票明细" :key="refKeys[0]" :forceRender="true">
        <j-editable-table
          ...
          <template slot="buttonAfter">
            <a-button type="primary" @click="getReferPoData" :disabled="formDisabled">参照销售出库单</a-button>
          </template>
        </j-editable-table>
      </a-tab-pane>
    ...
    <j-select-s-o-s-modal :client-id="model.clientId" @ok="selectOK" ref="selectSOS"/>
  </a-spin>
</template>
...
import JSelectSOSModal from '@/components/jeecgbiz/modal/JSelectSOSModal'
